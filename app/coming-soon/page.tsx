    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--background)' }}>
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 24px' }}>
        <div style={{ width: '100%', maxWidth: '560px' }}>
          ...
          {/* Eyebrow */}
          <p style={{ fontSize: '11px', fontFamily: 'sans-serif', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--muted)', margin: '0 0 28px' }}>
            Portugal · New Developments
          </p>

          {/* Site name */}
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 44px)', fontFamily: 'Georgia, Times New Roman, serif', fontWeight: 400, lineHeight: 1.15, letterSpacing: '-0.02em', color: 'var(--foreground)', margin: '0 0 8px' }}>
            Portugal Developments Review
          </h1>
          <p style={{ fontSize: '14px', fontFamily: 'sans-serif', letterSpacing: '0.04em', color: 'var(--muted)', margin: '0 0 32px' }}>
            by Viriato
          </p>
          ...
          <h2 style={{ fontSize: 'clamp(13px, 2vw, 15px)', fontFamily: 'sans-serif', fontWeight: 400, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--foreground)', margin: '0 0 20px' }}>
            Coming Soon
          </h2>

          {/* Description */}
          <p style={{ fontSize: '15px', fontFamily: 'Georgia, Times New Roman, serif', color: 'var(--muted)', lineHeight: 1.75, margin: '0 0 48px', maxWidth: '460px' }}>
          ...
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: '32px' }}>
            <p style={{ fontSize: '11px', fontFamily: 'sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--muted)', margin: '0 0 20px' }}>
      ...
      <footer style={{ borderTop: '1px solid var(--border)', padding: '24px', textAlign: 'center' }}>
        <p style={{ fontSize: '11px', fontFamily: 'sans-serif', letterSpacing: '0.06em', color: 'var(--muted)', margin: 0 }}>
